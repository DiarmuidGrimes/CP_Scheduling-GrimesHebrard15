...
void SchedulingSolver::jtl_presolve() 
{
  ...
  if( status == SAT ) {
    ...
    if(objective>new_objective) {
      ...
      std::cout << std::left << std::setw(30) << "d JTLGREEDYOBJ" << std::right << std::setw(21) << objective << std::endl;
    }
    
  } else {
      std::cout << std::left << std::setw(30) << "d JTLGREEDYOBJ" << std::right << std::setw(21) << 5000000 << std::endl;
...
void SchedulingSolver::dichotomic_search()
{
  ...
  if(!probe_ub()) {
    if(params->Presolve == "jtl_old") {
      ...
      std::cout << std::left << std::setw(30) << "d JTLGREEDYOBJ" << std::right << std::setw(21) << 0 << std::endl;
}
